" Vim syntax file
" Language:	php PHP 5
" Maintainer:	Michiel van Vaardegem <michiel@dotgeek.org>
" URL:		http://michiel.dotgeek.org/php.vim
" Email:	Subject: send syntax_vim.tgz
" Last Change:	Mon Apr 19 17:36:59 CEST 2004
"
" 		I edited the original php.vim from Lutz Eymers <ixtab@polzin.com> so it has php5 syntax support
"
...
" temp PHP5 shit
"syn keyword	phpKeyword	final private protected public	contained
"syn keyword	phpKeyword	abstract	contained
"syn keyword	phpStructure	interface implements	contained
"syn keyword	phpKeyword	try catch throw	contained
"syn keyword	phpDefine	clone	contained
syn keyword	phpFunctions	__construct __destruct __clone __toString __autoload __call __get __set	contained
"syn keyword	phpConstants	__METHOD__ __FUNCTION__ __CLASS__	contained
"syn keyword	phpCoreConstants	E_STRICT STDIN STDOUT STDERR	contained
"syn keyword    phpStorageClass	const
"syn keyword	phpKeyword	instanceof	contained
syn keyword	phpKeyword	self parent	contained
" End temp PHP5 shit
...
" Keyword
syn keyword	phpKeyword	instanceof var private public protected final	contained

" Type
syn keyword	phpType	bool[ean] int[eger] real double float string array object NULL	contained

" Structure
syn keyword	phpStructure	abstract extends interface implements	contained

" StorageClass
syn keyword	phpStorageClass	global static const	contained
...
syn cluster	phpClConst	contains=phpFunctions,phpIdentifier,phpConditional,phpRepeat,phpStatement,phpOperator,phpRelation,phpStringSingle,phpStringDouble,phpNumber,phpFloat,phpKeyword,phpType,phpBoolean,phpStructure,phpMethodsVar,phpConstants,phpCoreConstants
...
" match one line constructs here and skip them at folding
  syn match	phpDefine	"Function\(\s\+.*}\)\@="
  syn match	phpStructure	"Class\(\s\+.*}\)\@="

  set foldmethod=syntax
  syn region	phpFoldHtmlInside	matchgroup=Delimiter start="?>" end="<?\(php\)\=" contained transparent contains=@htmlTop
  syn region	phpFoldFunction	matchgroup=Define start="^\z\(\s*\)Function\s\+\([^}]*$\)\@=" matchgroup=Delimiter end="^\z1}" contains=@phpClFunction,phpFoldHtmlInside contained transparent fold extend
  syn region	phpFoldClass	matchgroup=Structure start="^\z\(\s*\)Class\s\+\([^}]*$\)\@=" matchgroup=Delimiter end="^\z1}" contains=@phpClFunction,phpFoldFunction contained transparent fold extend
...
if version >= 508 || !exists("did_php_syn_inits")
  ...
  HiLink	 phpConstants	Constants
  HiLink	 phpCoreConstants	Constants
